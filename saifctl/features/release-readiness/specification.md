...
| NPM-05 | B   | 👍     | README has three TODO markers — `<!-- TODO - LINK TO MARKETPLACE -->` (line 87), `<!-- TODO - EMBED VIDEO OR SCREENSHOT -->` (line 88), and `[Spec-driven development](./docs/spec-driven-development.md) <!-- TODO -->` (line 114). **Decision D-10:** resolve them by _filling in_, not by removing — write `docs/spec-driven-development.md` (see DOC-08), embed real screenshots/GIF (see WEB-06 for assets), and add the marketplace link once VSX-09 + VSX publish ship.                                                                                                                                                                                                                                                                                                                                                                                                | `README.md:87-88,114`                                                                                    |
