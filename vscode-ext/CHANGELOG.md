...
Each release of this extension declares a minimum compatible CLI version
(`MIN_CLI_VERSION`) and probes `saifctl --version` at activation; on
mismatch the user is prompted to install or upgrade.
