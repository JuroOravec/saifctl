...
async function writeNextestConfig(testsDir: string, force: boolean): Promise<void> {
  ...
  const content = `# Auto-generated by \`saifac feat design\`. Re-run to update.
[profile.ci]
 ...
 */
async function rustPlaywrightOnDone(opts: OnDoneOpts): Promise<void> {
  ...
  for (const subdir of ['public', 'hidden'] as const) {
    ...
    const modRsContent =
      `// Auto-generated by \`saifac feat design\`. Re-run to update.\n` +
