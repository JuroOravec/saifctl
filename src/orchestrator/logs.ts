...
/**
 * Builds {@link Provisioner.runAgent} / {@link Provisioner.startInspect} stdout callbacks.
 * The provisioner only forwards opaque chunks; here we pair {@link createAgentRunnerStdoutMux}
