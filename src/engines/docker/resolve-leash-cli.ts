 ...
 * Leash to be installed globally. Installing `@safe-ai-factory/saifctl` should be enough.
 *
 ...
 *
 * To resolve this, we search for the Leash CLI binary in the project that had `@safe-ai-factory/saifctl` installed.
 */
import { createRequire } from 'node:module';

// This will point to where this file is defined within the `node_modules`
// of the project that has `@safe-ai-factory/saifctl` installed.
